"""Script for training models for the IMDB dataset"""
import argparse
import random
...
from models.data_loader import BucketBatchSampler, IMDBDataset, collate_imdb
...
if __name__ == "__main__":
    ...
    collate_fn = partial(collate_imdb,
                         tokenizer=tokenizer,
                         device=device,
    ...
    if args.mode == 'test':
        ...
        for model_path in args.model_path:
            ...
            test = IMDBDataset(args.dataset_dir, type='test')
        ...
        train = IMDBDataset(args.dataset_dir, type='train')
        dev = IMDBDataset(args.dataset_dir, type='dev')
